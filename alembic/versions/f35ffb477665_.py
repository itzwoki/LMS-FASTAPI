...
Revision ID: f35ffb477665
Revises: 
Create Date: 2024-12-19 14:20:21.544043
...
role_enum = ENUM('teacher', 'student', name='role', create_type=False)
contenttype_enum = ENUM('lesson', 'quiz', 'assignment', name='contenttype', create_type=False)

def upgrade() -> None:
    # Create the ENUM type before using it
    op.execute("CREATE TYPE role AS ENUM ('teacher', 'student')")
    op.execute("CREATE TYPE contenttype AS ENUM ('lesson', 'quiz', 'assignment')")
